    ...
    public partial class Database
    {
        ...
        public void InsertPerson(Person person)
        {
            ...
            using (connection)
            {
                connection.Open();
                string queryString =
                    $"INSERT INTO dbo.Persons VALUES ('{person.firstName}', '{person.lastName}', '{person.phone}', '{person.email}', '{JsonConvert.SerializeObject(person.address)}', '{person.role.ToString()}', '{person.creationTimeStamp}')";
        ...
        public void UpdatePerson(Person person)
        {
            ...
            using (connection)
            {
                connection.Open();
                string queryString =
                    $"UPDATE dbo.Persons SET FirstName='{person.firstName}', LastName='{person.lastName}', PhoneNumber='{person.phone}', Mail='{person.email}', Address='{JsonConvert.SerializeObject(address)}' WHERE Id={person.id}";
