...
namespace App
{
    internal class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            List<Product> productList = new List<Product> { new Product("12", "test", 10.00, 10.0, "test", 10, Unit.meters) };
           ...
           // var order = new Sales(1234, timestamp, timestamp, "12", State.None, productList, 200);
            ...
            SalesFullListScreen salesFullListScreen = new SalesFullListScreen(listSales);
            Screen.Display(salesFullListScreen);
